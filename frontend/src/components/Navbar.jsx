...
const Navbar = ({ cartCount = 0, wishlistCount = 0 }) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-brand-cream/90 backdrop-blur-md border-b border-brand-sand/60 transition-all duration-300">
      ...
      <nav className="max-w-7xl mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
        <div className="hidden md:flex items-center space-x-8 text-xs font-semibold tracking-luxury uppercase text-brand-dark/80">
          ...
          <Link to="/shop?category=collections" className="hover:text-brand-champagne transition-colors">Collections</Link>
        ...
        <div className="flex items-center space-x-5 text-brand-dark">
          ...
          <Link to="/cart" className="relative hover:text-brand-champagne transition-colors">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-brand-cream border-t border-brand-sand px-6 py-6 space-y-4">
          ...
          <div className="flex flex-col space-y-3 pt-2 text-xs uppercase tracking-luxury text-brand-dark">
            ...
            <Link to="/shop?category=collections" onClick={() => setMobileMenuOpen(false)}>Collections</Link>
